...
function App() {
  var inputArray = Array(NUM_COLS).fill(0); // const mapFn = (n, i) => (console.log(n , i), i)
  // const mapFn = (n, i) => {
  //   console.log(n , i)
  //   return i
  // }

  var grid = inputArray.map(function (n, j) {
    return inputArray.map(function (n, i) {
      var x = 184 + j * 60;
      var y = 184 + i * 60 + Math.random() * 10;
      var width = 60;
      var height = 60;
      return {
        x: x,
